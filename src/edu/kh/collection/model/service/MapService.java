...
public class MapService {
	...
	// - Key를 모아두면 Set의특징을 가짐 (중복이 안되기 때문)
	// - Value를 모아두면 List의 특징을 가짐 (중복 가능)
	...
	public void ex1(){
		...
		// Key 중복
		map.put(1, "홍홍홍"); // 중복허용X, 대신 value를 덮어씀
	...
	public void ex2() {
		...
		// VO (값 저장용 객체)는 특정 데이터 묶음의 재사용이 많은 경우주료 사용
